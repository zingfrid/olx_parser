...
#        file.write(min_news_id.groups()[0])
    ...
    def _process_item(item):
        title, *_ = item.xpath(
            './/h6[contains(@class, "css-1wxaaza")]/text()'
            # css-1wxaaza
        ...
        name = item.xpath('.//h6[contains(@class, "css-1wxaaza")]/text()')[0]
#        print (item)
#        print(title)
#        print(name)
#        print(dirty_price)
...
if __name__ == '__main__':
    url = 'https://www.olx.ua/d/nedvizhimost/kvartiry/dolgosrochnaya-arenda-kvartir/uzhgorod/'
